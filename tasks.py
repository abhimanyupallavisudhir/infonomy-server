...
from utils import recompute_inbox_for_context  # your existing matcher helper
from llm import call_llm  # your wrapper around the child‐LLM
...
def inspect_task(
    ...
    chosen_ids, child_ctx = call_llm(context=ctx, offers=offers, buyer=buyer)
